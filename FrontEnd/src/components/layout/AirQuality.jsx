...
const AirQuality = () => {
  ...
  let colorClass = getColorClass(statsData[1]);
  let shadowClass = getShadowClass(statsData[1]);
  ...
  return (
    <section className="flex h-full lg:h-[69%] acBox col-span-1 flex-col md:row-span-2 lg:row-span-3">
      ...
      <div className="relative flex justify-center h-full items-center">
        ...
        <p className="md:text-sm lg:text-xl font-bold absolute tracking-wider z-20 dark:text-acBox-dark bottom-1/3 md:bottom-1/3 lg:top-2/3">AQI</p>
        <div
